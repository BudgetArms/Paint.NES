...
; Selection Menu
SELECTION_MENU_0_DRAW   = $BF + 0 * 8
SELECTION_MENU_1_SHAPE  = $BF + 1 * 8
SELECTION_MENU_2_ERASER = $BF + 2 * 8
SELECTION_MENU_3_FILL   = $BF + 3 * 8
SELECTION_MENU_4_CLEAR  = $BF + 4 * 8

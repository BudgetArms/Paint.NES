...
SELECT_PLAYER_MODE  = %00001000
CANVAS_MODE         = %00010000
HELP_MENU_MODE      = %00100000
SAVE_SAVE_MODE      = %01000000
TRANSITION_MODE     = %10000000

HELP_OR_TRANSITION_MODE = HELP_MENU_MODE + TRANSITION_MODE

; Transition
FIXED_TRANSITION_SPEED  = $04
FIXED_TRANSITION_TIME   = $FF

TRANSITION_SPEED_MULTIPLIER = 1
TRANSITION_SPEED            = TRANSITION_SPEED_MULTIPLIER * FIXED_TRANSITION_SPEED
TRANSITION_TIME             = FIXED_TRANSITION_TIME / TRANSITION_SPEED_MULTIPLIER
SKIP_TRANSITION_TIME        = TRANSITION_TIME - 1
...
; Start menu cursor offsets
START_MENU_CURSOR_X_OFFSET = 10 * TILE_PIXEL_SIZE
START_MENU_CURSOR_Y_OFFSET = (19 * TILE_PIXEL_SIZE) - 1

; Start menu
START_MENU_START_NEW_SELECTION  = START_MENU_CURSOR_Y_OFFSET
START_MENU_LOAD_SAVE_SELECTION  = START_MENU_START_NEW_SELECTION + (TILE_PIXEL_SIZE * 2)
START_MENU_CONTROLS_SELECTION   = START_MENU_LOAD_SAVE_SELECTION + (TILE_PIXEL_SIZE * 2)

; Select Player Menu selections
SELECT_PLAYER_MENU_1_PLAYER_SELECTION   = START_MENU_CURSOR_Y_OFFSET
SELECT_PLAYER_MENU_2_PLAYERS_SELECTION  = SELECT_PLAYER_MENU_1_PLAYER_SELECTION  + (TILE_PIXEL_SIZE * 2)
SELECT_PLAYER_MENU_GO_BACK_SELECTION    = SELECT_PLAYER_MENU_2_PLAYERS_SELECTION + (TILE_PIXEL_SIZE * 2)

; Load Save Menu selections
LOAD_SAVE_MENU_SAVE_0_SELECTION     = START_MENU_CURSOR_Y_OFFSET      - (TILE_PIXEL_SIZE * 2)
LOAD_SAVE_MENU_SAVE_1_SELECTION     = LOAD_SAVE_MENU_SAVE_0_SELECTION + (TILE_PIXEL_SIZE * 2)
LOAD_SAVE_MENU_SAVE_2_SELECTION     = LOAD_SAVE_MENU_SAVE_1_SELECTION + (TILE_PIXEL_SIZE * 2)
LOAD_SAVE_MENU_SAVE_3_SELECTION     = LOAD_SAVE_MENU_SAVE_2_SELECTION + (TILE_PIXEL_SIZE * 2)
LOAD_SAVE_MENU_GO_BACK_SELECTION    = LOAD_SAVE_MENU_SAVE_3_SELECTION + (TILE_PIXEL_SIZE * 2)

; Save Save Menu selections
SAVE_SAVE_MENU_SAVE_0_SELECTION     = START_MENU_CURSOR_Y_OFFSET      - (TILE_PIXEL_SIZE * 2)
SAVE_SAVE_MENU_SAVE_1_SELECTION     = SAVE_SAVE_MENU_SAVE_0_SELECTION + (TILE_PIXEL_SIZE * 2)
SAVE_SAVE_MENU_SAVE_2_SELECTION     = SAVE_SAVE_MENU_SAVE_1_SELECTION + (TILE_PIXEL_SIZE * 2)
SAVE_SAVE_MENU_SAVE_3_SELECTION     = SAVE_SAVE_MENU_SAVE_2_SELECTION + (TILE_PIXEL_SIZE * 2)
SAVE_SAVE_MENU_GO_BACK_SELECTION    = SAVE_SAVE_MENU_SAVE_3_SELECTION + (TILE_PIXEL_SIZE * 2)
